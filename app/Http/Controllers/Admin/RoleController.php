...
class RoleController extends Controller
{
    ...
    public function update(Request $request, Role $role)
    {
        ...
        return redirect()->route('admin.roles.index', $role)->with('info', 'El registro se actualizó correctamente');
    }
    ...
    public function destroy(Role $role)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info', 'Registro eliminado correctamente');
    }
}
