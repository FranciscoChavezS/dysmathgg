    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
                ...
                <p class="mb-2"><i class="fas fa-chart-line"></i> Categoría: {{$course->category->name}} </p>
            ...
            <section class="mb-12">
                ...
                @foreach ($course->sections as $section)
                    ...
                    @endif>
                        ...
                        <header class="border border-gray-200 px-4 py-2 cursor-pointer br-gray-200" x-on:click="open = !open">
            ...
            <section class="card mb-4">
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h1 class="font-bold text-gray-500 text-lg"> Profesor: {{$course->teacher->name}}</h1>
            ...
            <aside class="hidden lg:block">
                @foreach ($similares as $similar)
                    <article class="flex mb-6">
                        ...
                        <div class="ml-3">
                            <h1>
                                <a href="{{route('courses.show', $similar)}}" class="font-bold text-gray-500 mb-3">{{Str::limit($similar->title, 40)}}</a>
                            </h1>
