        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total de alumnos</th>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10">
                                @isset($course->image)
                                    ...
                                    @else
                                    <img class="h-10 w-10 rounded-full object-cover object-center" src="https://www.ghihornos.com/wp-content/uploads/2017/09/default.jpg" alt="">
